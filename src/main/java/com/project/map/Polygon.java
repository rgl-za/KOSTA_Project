...
public class Polygon {
    ...
    public static List<Point> pointToMidPoint(List<Point> inputPoints) {
    	...
    	//그냥 점들을 triangle리스트로 만드는 것까지
      	...
      	//System.out.println("resultPoints"+resultPoints);//ok
      	
      	//basketPoints.clear();//basketPoints를 비운다.
      	
      	//System.out.println("basketPoints"+basketPoints);//ok
      	//System.out.println("size:"+resultPoints.size());//ok, 6, 왜 resultPoints까지 clear되지?
      	
      	//test
      	//List<Triangle> subtrianlgeList = init(basketPoints);//초기화하고
      	//System.out.println("basketPoints"+basketPoints);//ok Point 2개 , why??
      	//System.out.println("basketPoints"+basketPoints.size());//ok Point 2개, why??
      	//System.out.println("subtrianlgeList"+subtrianlgeList);//ok, 4
  		return resultPoints;
  	}
    ...
    public static Point getMidPoint(Triangle tri){
    	//Triangle tri = new Triangle( new Point(0.0, 0.0) ,new Point(9.0, 0.0), new Point(4.0, 8.0) );
