...
public class PostController extends UiUtils {
	...
	// 게시글을 올리고 main으로
	/*
	 * @GetMapping(value = "/main.do") public String
	 * openPostList(@ModelAttribute("params") PostDTO params, Model model) {
	 * List<PostDTO> postList = postService.getPostList(params);
	 * model.addAttribute("postList", postList); logger.info("main.do"); return
	 * "/main"; }
	 */
...
//		return "/main";
	...
	public String openPostDetail(@ModelAttribute("params") PostDTO params,
			@RequestParam(value = "pnum", required = false) Long pnum, Model model, HttpSession session) {
